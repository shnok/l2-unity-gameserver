...
public class WizardCorpseVampireBasicAggressive extends WizardCorpseVampireBasic
{
	public WizardCorpseVampireBasicAggressive()
	{
		super("ai/individual/Monster/WizardBase/Wizard/WizardDDMagic2/WizardCorpseVampireBasic");
	}
	
	public WizardCorpseVampireBasicAggressive(String descr)
	{
		super(descr);
	}
