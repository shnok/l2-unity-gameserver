...
public class PartyPrivateHereticCastCurse extends PartyPrivateCastCurse
{
	public PartyPrivateHereticCastCurse()
	{
		super("ai/individual/Monster/WarriorBase/Warrior/PartyPrivateWarrior");
	}
	
	public PartyPrivateHereticCastCurse(String descr)
	{
		super(descr);
	}
