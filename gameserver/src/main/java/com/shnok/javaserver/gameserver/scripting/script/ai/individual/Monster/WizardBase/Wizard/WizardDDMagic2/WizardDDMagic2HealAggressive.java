...
public class WizardDDMagic2HealAggressive extends WizardDDMagic2Heal
{
	public WizardDDMagic2HealAggressive()
	{
		super("ai/individual/Monster/WizardBase/Wizard/WizardDDMagic2");
	}
	
	public WizardDDMagic2HealAggressive(String descr)
	{
		super(descr);
	}
