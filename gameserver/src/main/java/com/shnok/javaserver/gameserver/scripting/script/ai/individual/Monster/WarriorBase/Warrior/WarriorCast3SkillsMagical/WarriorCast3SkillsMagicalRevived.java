...
public class WarriorCast3SkillsMagicalRevived extends WarriorCast3SkillsMagical
{
	public WarriorCast3SkillsMagicalRevived()
	{
		super("ai/individual/Monster/WarriorBase/Warrior/WarriorCast3SkillsMagical");
	}
	
	public WarriorCast3SkillsMagicalRevived(String descr)
	{
		super(descr);
	}
