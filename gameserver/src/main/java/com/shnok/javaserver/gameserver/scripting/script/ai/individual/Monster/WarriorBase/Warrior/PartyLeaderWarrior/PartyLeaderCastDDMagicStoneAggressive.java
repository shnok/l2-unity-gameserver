...
public class PartyLeaderCastDDMagicStoneAggressive extends PartyLeaderCastDDAggressive
{
	public PartyLeaderCastDDMagicStoneAggressive()
	{
		super("ai/individual/Monster/WarriorBase/Warrior/PartyLeaderWarrior");
	}
	
	public PartyLeaderCastDDMagicStoneAggressive(String descr)
	{
		super(descr);
	}
