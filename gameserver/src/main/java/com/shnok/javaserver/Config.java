...
public final class Config
{
	...
	private static final String CLANS_FILE = "conf/clans.properties";
	private static final String EVENTS_FILE = "conf/events.properties";
	public static final String GEOENGINE_FILE = "conf/geoengine.properties";
	private static final String HEXID_FILE = "conf/hexid.txt";
	private static final String LOGINSERVER_FILE = "conf/loginserver.properties";
	private static final String NPCS_FILE = "conf/npcs.properties";
	private static final String PLAYERS_FILE = "conf/players.properties";
	private static final String SERVER_FILE = "conf/server.properties";
	private static final String SIEGE_FILE = "conf/siege.properties";
	...
	public static boolean DEATH_PENALTY_ENABLED;
	...
	public static int CLIENT_PACKET_QUEUE_MAX_AVERAGE_PACKETS_PER_SECOND = 80; // default 80 //TODO: Update
	...
	private static final void loadPlayers()
	{
		...
		DEATH_PENALTY_ENABLED = players.getProperty("DeathPenaltyEnabled", false);
	...
	private static final void loadServer()
	{
		...
		DATABASE_URL = server.getProperty("URL", "jdbc:mariadb://localhost/l2unity");
